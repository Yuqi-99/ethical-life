...
export const Footer = () => {
	...
	return (
		<>
			{/* <div className='bottom-radial-gradient-2 sticky top-0 bottom-0 flex h-full min-h-screen w-full' /> */}
			<div
			...
			>
				...
				<div className='flex w-full flex-col justify-between lg:flex-row'>
					<p className='max-w-75 text-start text-3xl font-semibold lg:max-w-100 lg:text-5xl'>
					...
					<div className='mt-12 flex w-2/3 flex-wrap justify-between gap-x-4 lg:mt-0 lg:w-2/5'>
						...
						<div className='flex flex-col items-start'>
							...
							{INDEX.map((item, index) => (
								<p key={index} className='mb-1 text-xl font-semibold lg:mb-0'>
									{item}
								</p>
							))}
						</div>
						...
						{/* Social */}
						<div className='flex flex-col items-start'>
							<p className='mb-2 text-sm font-medium'>Social</p>
							...
							{SOCIALS.map((item, index) => (
								<a
									...
									target='_blank'
									href={item.link}
									className='mb-1 text-xl font-semibold lg:mb-0'
								>
									{item.label}
								</a>
							))}
						...
						<div className='mt-10 flex flex-col items-start sm:mt-0'>
							...
							<p className='text-xl font-semibold'>hello@ethicallifeworld.com</p>
						</div>
					</div>
				</div>

				<div className='flex w-full flex-col justify-between font-medium sm:flex-row'>
					<p className='mb-10 text-start text-sm sm:mb-0'>© 2026 Ethical Life</p>

					<div className='flex w-full justify-between sm:w-2/3 lg:w-1/4'>
						<p className='text-sm lg:max-w-75'>Clone by Yuqi</p>
						<p className='text-sm lg:max-w-75'>Privacy Policy</p>
						<p className='text-sm lg:max-w-75'>Terms of Service</p>
					</div>
				</div>
			</div>
		</>
