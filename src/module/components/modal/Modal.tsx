...
// 	onClose: () => void;
// };
// export const Modal = ({ children, opened, onClose }: TModal) => {
// 	useEffect(() => {
...
// 	return (
// 		opened && (
// 			<div className='z-modal fixed flex h-full w-full max-w-[inherit] min-w-[inherit]'>
...
// 					<div className='z-modal-content absolute flex h-auto max-h-[90vh] w-[94%] flex-col items-center justify-center rounded-xl bg-black text-white'>
...
export const Modal = ({ children, opened, onClose }: TModal) => {
	...
	return (
		opened && (
			...
			>
				<ModalOverlay opened={opened} onClose={handleClose} />
				<div className='z-modal-content fixed top-1/2 left-1/2 flex h-auto max-h-[90vh] w-screen max-w-[inherit] min-w-[inherit] -translate-x-1/2 -translate-y-1/2 items-center justify-center'>
					<div
						ref={modalRef}
						className='z-modal-content absolute flex h-auto max-h-[90vh] w-[94%] flex-col items-center justify-center rounded-xl bg-black text-white'
					>
						<div className='flex w-full flex-col overflow-y-auto px-4'>{children}</div>
					</div>
				</div>
